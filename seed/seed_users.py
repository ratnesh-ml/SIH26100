...
DEV_USERS = [
    ...
    },
    {
        ...
        "email": "approver@cpcl.gov.in",
        "full_name": "Dr. K. Swaminathan, Chief General Manager (Refinery Projects)",
        "role": "approver",
        "password": "Approver@CPCL2026!",
    },
    {
        "id": uuid.UUID("33333333-3333-4333-8333-333333333333"),
        "email": "auditor@cvc.gov.in",
        "full_name": "R. Venkatram, Independent External Monitor / Vigilance Auditor",
        "role": "auditor",
        "password": "Auditor@CVC2026!",
    },
    {
