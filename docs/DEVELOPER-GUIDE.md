...
|---|---|---|
| **API & Contracts** | `backend/routers/` | [docs/FINAL-API.md](FINAL-API.md) & [docs/INTERFACE-CONTRACTS.md](INTERFACE-CONTRACTS.md) |
| **Database & Schema** | `backend/models/` | [docs/FINAL-DATABASE.md](FINAL-DATABASE.md) & [docs/DATABASE.md](DATABASE.md) |
| **Document Ingestion** | `pipeline/steps/step01_ingest.py` | [docs/SECURITY.md](SECURITY.md) & [docs/SECURITY-AUDIT.md](SECURITY-AUDIT.md) |
| **OCR & Text Extraction** | `pipeline/ocr/ocr_engine.py` | [docs/OCR.md](OCR.md) & [docs/decisions/ADR-002-ocr-abstraction.md](decisions/ADR-002-ocr-abstraction.md) |
| **Entity Resolution** | `pipeline/steps/step06_entity_resolution.py` | [docs/NORMALIZATION.md](NORMALIZATION.md) |
| **Registry Adapters** | `pipeline/registry/` | [docs/REGISTRY.md](REGISTRY.md) & [docs/decisions/ADR-003-mock-government-registries.md](decisions/ADR-003-mock-government-registries.md) |
| **Compliance Rules** | `pipeline/rules/rule_engine.py` | [docs/RULE-ENGINE.md](RULE-ENGINE.md) & [docs/decisions/ADR-004-deterministic-compliance-engine.md](decisions/ADR-004-deterministic-compliance-engine.md) |
| **Anomaly Detection** | `pipeline/anomalies/anomaly_engine.py` | [docs/ANOMALIES.md](ANOMALIES.md) |
| **Risk Scoring** | `pipeline/risk/risk_engine.py` | [docs/RISK-ENGINE.md](RISK-ENGINE.md) & [docs/decisions/ADR-008-risk-methodology.md](decisions/ADR-008-risk-methodology.md) |
| **Evidence System** | `backend/models/evidence.py` | [docs/EVIDENCE.md](EVIDENCE.md) & [docs/decisions/ADR-005-evidence-first-architecture.md](decisions/ADR-005-evidence-first-architecture.md) |
...
| **PDF Dossier Reports** | `pipeline/reports/pdf_generator.py` | [docs/PDF-CONTRACT.md](PDF-CONTRACT.md) |
